...
public class VentanaEstudiante extends JFrame {
    ...
    private void agregarEstudiante() {
        try {
            ...
            institucionFacade.agregarEstudiante(institucionFacade.obtenerEstudiante(), estudiante);
            actualizarTabla();
            limpiarCampos();
        } catch (Exception ex) {
    ...
    private void actualizarEstudiante() {
        try {
            ...
            Estudiante estudiante = new Estudiante(idEstudiante, nombre, grado, correo);
            institucionFacade.actualizarEstudiante(institucionFacade.obtenerEstudiante(), estudiante);
            actualizarTabla();
            limpiarCampos();
        } catch (Exception ex) {
    ...
    private void eliminarEstudiante() {
        try {
            ...
            institucionFacade.eliminarEstudiante(institucionFacade.obtenerEstudiante(), id);
            actualizarTabla();
            limpiarCampos();
        } catch (Exception ex) {
    ...
    private void actualizarTabla() {
        ...
        for (Estudiante e : institucionFacade.obtenerEstudiante()) {
